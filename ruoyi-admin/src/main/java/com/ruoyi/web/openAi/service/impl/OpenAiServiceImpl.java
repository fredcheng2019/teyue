 ...
 */
package com.ruoyi.web.openAi.service.impl;
...
import com.ruoyi.web.openAi.config.OpenAiConfig;
import com.ruoyi.web.openAi.service.OpenAiService;
import com.ruoyi.web.openAi.service.WebSocketServer;
import com.ruoyi.web.openAi.service.dto.OpenAiRequest;
import com.ruoyi.web.openAi.service.dto.OpenAiResult;
...
public class OpenAiServiceImpl implements OpenAiService {
    ...
    private void textQuiz(Integer maxTokens, OpenAiRequest openAiRequest, String apikey, WebSocketServer webSocketServer) throws Exception {
        ...
        log.info("请求报文："+JSONUtil.toJsonStr(params));
        // 调用接口
        HttpResponse result;
        try {
