...
public class OpenAiService {
    ...
    private static final String BASE_URL = "http://52.77.229.255/";
...
/**
    ...
    public OpenAiService(final String token) {
        this(token, BASE_URL, ofSeconds(10), null, null);
    }
...
/**
     ...
     * @deprecated use {@link com.theokanning.openai.OpenAiService (String, Duration )}
     *//*

    //@Deprecated
    public OpenAiService(final String token, final int timeout) {
        this(token, BASE_URL, ofSeconds(timeout), null, null);
    }

    public OpenAiService(final String token, final String ip, final Integer port) {
        this(token, BASE_URL, ofSeconds(10), ip, port);
    }

    public OpenAiService(final String token, final int timeout, final String ip, final Integer port) {
        this(token, BASE_URL, ofSeconds(timeout), ip, port);
    }
...
/**
    ...
    public OpenAiService(final String token, final Duration timeout) {
        this(token, BASE_URL, timeout, null ,null);
    }
...
/**
    ...
    public OpenAiService(final String token, final String baseUrl, final Duration timeout, String ip, Integer port) {
...
/**
    ...
    */
/**
     * Use {@link com.theokanning.openai.OpenAiService#createCompletion(CompletionRequest)} and {@link CompletionRequest#}instead
     *//*
    ...
    */
/**
     * Use {@link com.theokanning.openai.OpenAiService#createEdit(EditRequest)} and {@link EditRequest#}instead
     *//*
    ...
    */
/**
     * Use {@link com.theokanning.openai.OpenAiService#createEmbeddings(EmbeddingRequest)} and {@link EmbeddingRequest#}instead
     *//*
