...
public class CheckPayThreadTest {

	public static final String key = "MUH3UYUMMSPVYAKV";

	// 交易接口
	public static final String POST_URL = "http://localhost:9082/sifang/pay/orderQuery";
			...
			new Thread(new Runnable() {
				...
				public void run() {
					try {
						...
						String post_data = "mch_id=RER26R6AJYJDX5E3&out_trade_no=";
