 ...
 */
@RestController
public class MerchantSimulateNotifyPayController extends BaseController {
	private static int RSP_TYPE =1;
	private static Logger log = LoggerFactory.getLogger(MerchantSimulateNotifyPayController.class);

	@RequestMapping(value = "/merchant/simulateNotifyPay")
	public void merchantSimulateNotifyPay(HttpServletRequest request,HttpServletResponse response) {
