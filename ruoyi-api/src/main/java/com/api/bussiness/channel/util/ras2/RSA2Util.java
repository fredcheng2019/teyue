package com.api.bussiness.channel.util.ras2;
...
public class RSA2Util {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String publicKey = Base64Utils.encodeToString(keyMap.get(RSA2.PUBLIC_KEY));

        System.out.println("验签公钥==>" + publicKey);

        String privateKey = Base64Utils.encodeToString(keyMap.get(RSA2.PRIVATE_KEY));
...
//
        ...
        try {
           ...
           /* String enpublicKey=Base64Utils.encodeToString( keyMap.get(RSA2.PUBLIC_KEY));

            System.out.println("加密公钥="+enpublicKey);

            String deprivateKey=Base64Utils.encodeToString(keyMap.get(RSA2.PRIVATE_KEY));
...
*/
    ...
    public String encrypt(String data, String publicKey) {
        try {
            ...
            X509EncodedKeySpec pub_spec = new X509EncodedKeySpec(Base64Utils.decodeFromString(publicKey));
    ...
    public static String encryptByPrivateKey(String content, String privateKey) throws Exception {
        Key privateK = RSA2.restorePrivateKey(Base64Utils.decodeFromString(privateKey));
        Cipher cipher = Cipher.getInstance(RSA2.KEY_ALGORITHM);
        ...
        out.close();
        return new String(Base64Utils.encodeToString(encryptedData));
    }
    ...
    public String decrypt(String data, String privateKey) throws Exception {
        try {
            PKCS8EncodedKeySpec priv_spec = new PKCS8EncodedKeySpec(Base64Utils.decodeFromString(privateKey));
            KeyFactory mykeyFactory = KeyFactory.getInstance("RSA");
     ...
     * @return 返回签名后的字符串
     */
    public String signByMap(String privateKey, Map<String, String> maps) {
    ...
    public String signStr(String privateKey, String plainText) {
        return Base64Utils.encodeToString(sign(RSA2.restorePrivateKey(Base64Utils.decode(privateKey.getBytes())), plainText));
    }
     ...
     * @return
     */
    public boolean verifySignByMap(String publicKey, Map<String, String> maps, String signValue) {
        String plainText = splitParams(getParamsKeyList(maps), maps);
    ...
    public boolean verifySignStr(String publicKey, String plainText, String signValue) {
        return verifySign(RSA2.restorePublicKey(Base64Utils.decodeFromString(publicKey)), plainText, hexStringToBytes(signValue));
    }
...
//    }
     ...
     */
    private String splitParams(List<String> keys, Map<String, String> maps) {
     ...
     * @return
     */
    public List<String> getParamsKeyList(Map<String, String> maps) {
