...
public class SysLoginService {
    ...
    public SysUser login(String username, String password) {
        ...
        //获取谷歌
       // String googleCode = (String) ServletUtils.getRequest().getAttribute(ShiroConstants.CURRENT_CAPTCHA);
        // 验证码校验
       /* if (!StringUtils.isEmpty(user.getGoogleSecret())) {
            if (StringUtils.isEmpty(googleCode)) {
                throw new CaptchaException();
            }
            if (!GoogleCodeUtil.ValidCode(googleCode, user.getGoogleSecret())) {
        ...
        //验证码校验
        String validateCode = (String) ServletUtils.getRequest().getAttribute(ShiroConstants.CURRENT_CAPTCHA);
